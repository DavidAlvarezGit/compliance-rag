        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "or cited legal instrument. Unless the question explicitly names another jurisdiction, use "
                    "Switzerland as the default jurisdiction. A cited Swiss law, FINMA instrument, or FMIA "
                    "provision establishes that Swiss context without requiring each claim to repeat it. Basel "
                    "standards remain international unless the evidence supports their Swiss implementation. "
                    "In particular, do not reject an otherwise supported claim only "
